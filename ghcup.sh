...
#   * GHCUP_BASE_URL - the base url for ghcup binary download (use this to overwrite https://mirrors.ustc.edu.cn/ghcup/downloads.haskell.org/~ghcup with a mirror)
...
arch=$(uname -m)
ghver="0.1.19.2"
: "${GHCUP_BASE_URL:=https://mirrors.ustc.edu.cn/ghcup/downloads.haskell.org/~ghcup}"
